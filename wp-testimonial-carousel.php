...
* Description: WP Testimonial Carousel Plugin is for Add Testimonials with this Shortcode '[testimonials]'.
* Version: 1.0.0
...
add_action( 'init', 'testimonial_list' );
...
function wprts_wptech_register_scripts() {
    if (!is_admin()) {
        // register
        wp_register_script('wptechnology_Testimonials_script', plugins_url('js/owl.carousel.min.js', __FILE__));
		// enqueue
        wp_enqueue_script('wptechnology_Testimonials_script');
...
add_action('wp_footer', 'wprts_wptech_register_styles');
function wprts_wptech_register_styles() {
	// register
    wp_register_style('wptechnology_Testimonials_styles', plugins_url('css/owl.carousel.css', __FILE__));
    wp_register_style('wptechnology_Testimonials_styles_theme', plugins_url('css/owl.theme.css', __FILE__));
    // enqueue
    wp_enqueue_style('wptechnology_Testimonials_styles');
    wp_enqueue_style('wptechnology_Testimonials_styles_theme');
    }
?>
